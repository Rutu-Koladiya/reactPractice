...
export default function WelcomePage() {
  ...
  // 1st number of pixel user scrolled, 2nd taken an array of break points, 3rd an array of values(we added opacity values) break points and the values between break points should be transformed too.
